	...
	void save()
		{
			...
			FileOperations::createFile("results-esumm-mult.txt",text);
		}
...
private:
	...
	double decode;
	double decode_without_write; //nao da para calcular por causa das threads
	...
	double feat_detec_desc; //neste caso essa parte tbm é paralela
	double feat_detec_desc_parallel_part; //nao da para calcular por causa das threads
